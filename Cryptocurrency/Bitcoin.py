...
#Creaating an address for node on port 5000
...
def mine_block():
    ...
    blockchain.add_transactions(sender=node_address, receiver='Hossein', amount=50)
...
def add_transaction():
    ...
    if not all (key in transaction_keys for key in json):
